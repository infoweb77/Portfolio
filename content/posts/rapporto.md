...
Встроил шифрование заголовков http-запросов, защитил SDK от дебага и скрыл внутреннюю логику библиотеки путем настройки видимости символов (Visibility Hidden) и проверки итогового ARM64-бинарника в Ghidra.   
